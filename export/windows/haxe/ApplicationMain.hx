...
class ApplicationMain
{
	...
	{
		lime.system.System.__registerEntryPoint("Roll, Dash, Fight!", create);

		#if (js && html5)
		#if (munit || utest)
		lime.system.System.embed("Roll, Dash, Fight!", null, 640, 480);
		#end
		#else
		create(null);
		#end
	...
	public static function create(config):Void
	{
		...
		app.meta["file"] = "Roll, Dash, Fight!";
		app.meta["name"] = "Roll, Dash, Fight!";
